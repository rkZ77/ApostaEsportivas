...
export const MODULOS: Modulo[] = [
  ...
  },
  {
    ...
    desc: 'Um motor separado lê a partida em andamento e publica quando o placar contraria o que o mercado precificou.',
    plano: 'vip',
  ...
  },
  {
    Icon: Zap,
    titulo: 'Pick Boost',
    desc: 'Varre os mercados alternativos do jogo atrás da linha que a casa esqueceu de corrigir.',
    plano: 'vip',
    tag: { label: 'VIP', tone: 'blue' },
  },
  {
