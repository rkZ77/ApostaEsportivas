      ...
      >
        ...
        <div className="px-5 pb-5">
          ...
          <motion.button
            whileTap={{ scale: 0.98 }}
            onClick={assinar}
            className="w-full py-3 rounded-lg bg-green-600 hover:bg-green-500 text-on-fill text-sm font-black transition-colors flex items-center justify-center gap-2"
          >
