...
/* O client_id vem do backend, não de uma VITE_ do build · ligar o Google passa
   ...
   memorizada no módulo porque a tela de login monta este componente de novo a
   cada troca entre "entrar" e "criar conta". */
...
export default function GoogleSignInButton({ onCredential, onError, onDisponivel, modo = 'login' }: Props) {
  ...
  /* O container fica montado e visível desde o início, mesmo vazio: é dele que
     sai a largura passada pro widget, e um `display:none` mediria zero. */
