        ...
        <div className="flex gap-2 mb-4">
          ...
          <div className="flex-1 flex gap-2">
            ...
            <button
              ...
              className="px-4 py-2 bg-green-600 hover:bg-green-500 disabled:opacity-40 disabled:cursor-not-allowed rounded-lg text-on-fill text-sm font-bold transition-colors shrink-0"
            >
              {submitting ? '...' : 'Enviar'}
            </button>
          </div>
