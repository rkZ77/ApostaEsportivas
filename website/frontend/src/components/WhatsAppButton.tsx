...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex items-center gap-2.5 bg-[#25D366] hover:bg-[#20ba58] text-white text-sm font-bold px-4 py-3 rounded-full shadow-lg shadow-black/40 transition-all hover:scale-105 active:scale-95"
    >
